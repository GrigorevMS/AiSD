...
// класс реализующий просматриваемые таблицы
class TScanTable : public TArrayTable {
	...
	*/
	...
	// методы класса
public:
	TScanTable(int tabsize_copy = TABMAXSIZE, int columncount_copy = 1, std::string * columnname_copy = nullptr); // конструктор класса
